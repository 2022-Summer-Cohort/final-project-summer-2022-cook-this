//Generated:2022-07-01 17:41:06// 6-269
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5680378 || '',
    guid: window.ftGUID_5680378 || '',
    confID: window.ftConfID_5680378 || '0',
    ftReturn: window.ftReturn_5680378 || '',
    keyword: window.ftKeyword_5680378 || '',
    ftId: window.ftId_5680378 || '',
    ftImpId: window.ftImp5680378 && window.ftImp5680378.impID || '',
    gdpr: window.ftImp5680378 && window.ftImp5680378.gdpr || '',
    gdpr_consent: window.ftImp5680378 && window.ftImp5680378.gdpr_consent || '',
    gdpr_pd: window.ftImp5680378 && window.ftImp5680378.gdpr_pd || '',
    us_privacy: window.ftImp5680378 && window.ftImp5680378.us_privacy || '',
    campaignID: '115844',
    cID: '155970',
    pID: '5680378',
    creativeID: '3871106',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115844&sid=18300&plc=5680378&num=&adid=&advid=&adsrv=29&btreg=5680378&btadsrv=flashtalking&crt=3871106&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["http://servedby.flashtalking.com/click/8/115844;5680378;3871106;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?221640703-5680378;3871106;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/568/5680378/3871106/image/3871106.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115844;5680378;202;pixel;Verizon;VerizonFY20CCLALPredictiveSegmentConversionUSDSKBAN300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: "http://servedby.flashtalking.com/click/8/115844;5680378;3871106;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv5680378',
    altimgID: 'ftalt5680378',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp5680378 && parseInt(window.ftImp5680378.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m5680378') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5680378'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_5680378").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_5680378").style.display = "none";
		    }
		});
	}
}(ft5680378));
...
(function(o) {
    o.addEventListener("obaEnd", function(){
        try {
            document.getElementById("ftAdChoices_5680378").style.zIndex = "99";
        } catch(e){
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115844&l2=Verizon&l3=5680378&l4=3871106&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115844&l2=Verizon&l3=5680378&l4=3871106&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_5680378;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_5680378;
