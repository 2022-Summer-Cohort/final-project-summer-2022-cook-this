                        ...
                        <section class="recipe-list">
                            ...
                            <div class="card recipe-cards text-center">
                                <a id="videoId2"> 
                                    ...
                                    <p class="card-text">Learn how to balance flavors using only your talent and creativity</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="card recipe-cards text-center">
                                <a id="videoId3"> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Plan our week's meals all at once. No more scrambling in the Mcdonalds line last minute.</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="card recipe-cards text-center">
                                <a id="videoId5"> 
                                    ...
                                    <p class="card-text">Not rich? No problem. Watch this for basic bugeting for beginners when your ballin' on a budget</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="card recipe-cards text-center">
                                <a id="videoId6">
                                    ...
                                    <p class="card-text">Found a recipe online? Find out how to save it to your bookmarks in a recipe folder</p>
                                    </div>
                                </a>
                            </div>
                        </section>
