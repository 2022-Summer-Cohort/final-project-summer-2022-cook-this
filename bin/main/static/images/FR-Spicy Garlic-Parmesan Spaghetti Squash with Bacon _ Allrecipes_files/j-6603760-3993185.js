//Generated:2022-07-29 15:54:20// 39-533
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6603760 || '',
    GUID: window.ftGUID_6603760 || '99999999999',
    confID: window.ftConfID_6603760 || '0',
    ftReturn: window.ftReturn_6603760 || '',
    keyword: window.ftKeyword_6603760 || '',
    ftId: window.ftId_6603760 || '',
    imp: window.ftImp6603760,
    ftImpId: window.ftImp6603760 && window.ftImp6603760.impID || '',
    gdpr: window.ftImp6603760 && window.ftImp6603760.gdpr || '',
    gdpr_consent: window.ftImp6603760 && window.ftImp6603760.gdpr_consent || '',
    gdpr_pd: window.ftImp6603760 && window.ftImp6603760.gdpr_pd || '',
    us_privacy: window.ftImp6603760 && window.ftImp6603760.us_privacy || '',
    campaignID: '186233',
    cID: '166373',
    pID: '6603760',
    creativeID: '3993185',
    exttrack: [
      'https://secure.insightexpressai.com/adServer/adServerESI.aspx?script=false&bannerID=10591509&siteID=9622&creativeID=3993185&placementID=6603760&ValueA=[%FT_CONFID%]&DID=[%IDFA%]&rnd=[%FT_RANDOM%]&redir=https://secure.insightexpressai.com/adserver/1pixel.gif'
    ],
    extscript: [
      ""
    ],
    clickTags: [
      "https://servedby.flashtalking.com/click/8/186233;6603760;3993185;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.absolut.com/us/world-of-absolut-cocktails/?AvpPassThrough=1"
    ],
    placementDescription: '300x250',
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    siteName: 'TheTradeDesk',
    divID: 'ftdiv6603760',
    phID: 'ftpos6603760',
    frameID: 'ftframe6603760',
    expID: 'ftexpframe6603760',
    altImgID: 'ftalt6603760',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'https://servedby.flashtalking.com/click/8/186233;6603760;3993185;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.absolut.com/us/world-of-absolut-cocktails/?AvpPassThrough=1',
    altImg: 'https://servedby.flashtalking.com/imp/8/186233;6603760;204;gif;TheTradeDesk;300x250/?',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/186233;6603760;271;pixel;TheTradeDesk;300x250/?',
    stump: 'https://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/660/6603760/3993185/js/j-6603760-3993185.js',
    file: 'http://cdn.flashtalking.com/166373/3993185/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224263058-6603760;3993185;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_6603760 || '',
    segmentList: window.ftSegmentList_6603760 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6603760 && window.ftImp6603760.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6603760') && /^https:/.test(document.getElementById('ftscript_m6603760').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6603760'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6603760'],
      ['ftcfid', 'ftConfID_6603760'],
      ['fttime', 'ftTimestamp_6603760'],
      ['ftsection', 'ftSection_6603760'],
      ['ftcustom', 'ftCustom_6603760'],
      ['ft_id', 'ftId_6603760'],
      ['ftimpid', 'ftImp6603760', 'impID'],
      ['gdpr', 'ftImp6603760', 'gdpr'],
      ['gdpr_consent', 'ftImp6603760', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6603760', 'gdpr_pd'],
      ['us_privacy', 'ftImp6603760', 'us_privacy']
    ]
  };
