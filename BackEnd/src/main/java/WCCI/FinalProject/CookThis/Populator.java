...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category category5 = new Category("Dessert", "/images/categories-images/dessert-category.png");
        categoryRepo.save(category5);
        Category category6 = new Category("CrockPot", "/images/categories-images/crockpot-category.jpg");
        categoryRepo.save(category6);
        Category category7 = new Category("Mediterranean", "/images/categories-images/meditteranean-category.png");
        categoryRepo.save(category7);
        Category category8 = new Category("Appetizer", "/images/categories-images/appetizer-category.jpg");
        categoryRepo.save(category8);
        Category category9 = new Category("Sandwich", "/images/categories-images/sandwich-category.jpg");
        categoryRepo.save(category9);
        Category category10 = new Category("Bread", "/images/categories-images/bread-category.png");
        categoryRepo.save(category10);
        Category category11 = new Category("Healthy", "/images/categories-images/healthy-category.jpg");
        categoryRepo.save(category11);
        Category category12 = new Category("Gluten Free", "/images/categories-images/glutenfree-category.jpg");
        categoryRepo.save(category12);
        Category category13 = new Category("Vegan", "/images/categories-images/vegan-category.jpg");
        categoryRepo.save(category13);
        Category category14 = new Category("Vegetarian", "/images/categories-images/vegetarian-category.jpg");
        categoryRepo.save(category14);
        Category category15 = new Category("Pasta", "/images/categories-images/pasta-category.jpg");
        categoryRepo.save(category15);
        Category category16 = new Category("Spicy", "/images/categories-images/spicy-category.png");
        categoryRepo.save(category16);
        Category category17 = new Category("Savory", "/images/categories-images/savory-category.png");
        categoryRepo.save(category17);
