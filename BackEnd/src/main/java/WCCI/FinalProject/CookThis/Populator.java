...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Ingredient burrIngredient1 = new Ingredient("large russet potatoes, peeled and grated","/images/cumin-ground-and-seed.jpeg","2","1",1, recipe2);
        ingredientRepo.save(burrIngredient1);
        Ingredient burrIngredient2 = new Ingredient("breakfast sausage, ground (not links)","/images/cumin-ground-and-seed.jpeg","1 lb","0",0, recipe2);
        ingredientRepo.save(burrIngredient2);
        Ingredient burrIngredient3 = new Ingredient("eggs, beaten","/images/cumin-ground-and-seed.jpeg","6","3",3, recipe2);
        ingredientRepo.save(burrIngredient3);
        Ingredient burrIngredient4 = new Ingredient("olive oil","/images/cumin-ground-and-seed.jpeg","2 tbsp","2",2, recipe2);
        ingredientRepo.save(burrIngredient4);
        Ingredient burrIngredient5 = new Ingredient("salt","/images/cumin-ground-and-seed.jpeg","1 tsp","4",4, recipe2);
        ingredientRepo.save(burrIngredient5);
        Ingredient burrIngredient6 = new Ingredient("ground pepper","/images/cumin-ground-and-seed.jpeg","1/4 tsp","3",3, recipe2);
        ingredientRepo.save(burrIngredient6);
        Ingredient burrIngredient7 = new Ingredient("bunch green onions, white and green parts, chopped","/images/cumin-ground-and-seed.jpeg","","3",3, recipe2);
        ingredientRepo.save(burrIngredient7);
        Ingredient burrIngredient8 = new Ingredient("large flour tortillas","/images/cumin-ground-and-seed.jpeg","6","2",2, recipe2);
        ingredientRepo.save(burrIngredient8);
        Ingredient burrIngredient9 = new Ingredient("cheddar cheese, grated","/images/cumin-ground-and-seed.jpeg","2 cups","4",4, recipe2);
        ingredientRepo.save(burrIngredient9);
        Ingredient burrIngredient10 = new Ingredient("avocados, sliced","/images/cumin-ground-and-seed.jpeg","2","6",6, recipe2);
        ingredientRepo.save(burrIngredient10);
        Ingredient burrIngredient11 = new Ingredient("salsa","/images/cumin-ground-and-seed.jpeg","To Taste","2",2, recipe2);
        ingredientRepo.save(burrIngredient11);
        Ingredient burrIngredient12 = new Ingredient("fresh cilantro","/images/cumin-ground-and-seed.jpeg","To Taste","1",1, recipe2);
        ...
        Ingredient thirdIngredient1 = new Ingredient("Cups of Water","/images/cumin-ground-and-seed.jpeg", "3","4",4, recipe3);
        ingredientRepo.save(thirdIngredient1);
        Ingredient thirdIngredient2 = new Ingredient("Tablespoons Peanut Oil", "/images/cumin-ground-and-seed.jpeg","","1",1, recipe3);
        ...
        Ingredient thirdIngredient5 = new Ingredient("Teaspoon Minced Garlic", "/images/cumin-ground-and-seed.jpeg","r","4", 4, recipe3);
        ingredientRepo.save(thirdIngredient5);
        Ingredient thirdIngredient6 = new Ingredient("Teaspoon Red Pepper Flakes", "/images/cumin-ground-and-seed.jpeg","","4",4, recipe3);
        ingredientRepo.save(thirdIngredient6);
        Ingredient thirdIngredient7 = new Ingredient("Tablespoons Soy Sauce", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe3);
        ingredientRepo.save(thirdIngredient7);
        Ingredient thirdIngredient8 = new Ingredient("Frozen Petite Peas", "/images/cumin-ground-and-seed.jpeg","","3",3, recipe3);
        ingredientRepo.save(thirdIngredient8);
        Ingredient thirdIngredient9 = new Ingredient("Teaspoons of Sesame Oil","/images/cumin-ground-and-seed.jpeg","","1",1, recipe3);
        ingredientRepo.save(thirdIngredient9);
        Ingredient thirdIngredient10 = new Ingredient("Roasted Peanuts","/images/cumin-ground-and-seed.jpeg","","3",3, recipe3);
        ...
        Ingredient fourthIngredient2 = new Ingredient("Tablespoon Olive Oil", "/images/cumin-ground-and-seed.jpeg","","4",4, recipe4);
        ingredientRepo.save(fourthIngredient2);
        Ingredient fourthIngredient3 = new Ingredient("slice bacon cut in to pieces", "/images/cumin-ground-and-seed.jpeg","","3",4, recipe4);
        ingredientRepo.save(fourthIngredient3);
        Ingredient fourthIngredient4 = new Ingredient("Tablespoon unsalted butter", "/images/cumin-ground-and-seed.jpeg","","3",4, recipe4);
        ingredientRepo.save(fourthIngredient4);
        Ingredient fourthIngredient5 = new Ingredient("Cloves of Minced Garlic", "/images/cumin-ground-and-seed.jpeg","","8",8, recipe4);
        ingredientRepo.save(fourthIngredient5);
        Ingredient fourthIngredient6 = new Ingredient("Grated parmesan cheese", "/images/cumin-ground-and-seed.jpeg","","1",1, recipe4);
        ingredientRepo.save(fourthIngredient6);
        Ingredient fourthIngredient7 = new Ingredient("Salt and ground pepper to taste", "/images/cumin-ground-and-seed.jpeg","","3",3, recipe4);
        ingredientRepo.save(fourthIngredient7);
        Ingredient fourthIngredient8 = new Ingredient("Teaspoon Chopped fresh oregon", "/images/cumin-ground-and-seed.jpeg","","3",3, recipe4);
        ingredientRepo.save(fourthIngredient8);
        Ingredient fourthIngredient9 = new Ingredient("Teaspoon crushed red pepper flakes", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe4);
        ingredientRepo.save(fourthIngredient9);
        Ingredient fourthIngredient10 = new Ingredient("Grated parmesan cheese","/images/cumin-ground-and-seed.jpeg","","3",3, recipe4);
        ...
        Ingredient indoIngredient2 = new Ingredient(" Low-fat yoghurt","/images/cumin-ground-and-seed.jpeg","","0",0, recipe5);
        ingredientRepo.save(indoIngredient2);
        Ingredient indoIngredient3 = new Ingredient(" low-fat yoghurt","/images/cumin-ground-and-seed.jpeg","","0",0, recipe5);
        ingredientRepo.save(indoIngredient3);
        Ingredient indoIngredient4 = new Ingredient(" ActiFry spoon vegetable oil", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe5);
        ingredientRepo.save(indoIngredient4);
        Ingredient indoIngredient5 = new Ingredient("Onion, finely chopped", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe5);
        ingredientRepo.save(indoIngredient5);
        Ingredient indoIngredient6 = new Ingredient("Package whole peeled tomatoes", "/images/cumin-ground-and-seed.jpeg","","1",1, recipe5);
        ingredientRepo.save(indoIngredient6);
        Ingredient indoIngredient7 = new Ingredient(" Water","/images/cumin-ground-and-seed.jpeg","","2",2, recipe5);
        ingredientRepo.save(indoIngredient7);
        Ingredient indoIngredient8 = new Ingredient("ActiFry spoon sugar", "/images/cumin-ground-and-seed.jpeg","","3",3, recipe5);
        ingredientRepo.save(indoIngredient8);
        Ingredient indoIngredient9 = new Ingredient("Small bunch chopped fresh coriander leaves", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe5);
        ...
        Ingredient tofuIngredient2 = new Ingredient(" Large onion, chopped", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient2);
        Ingredient tofuIngredient3 = new Ingredient(" Tablespoon finely chopped garlic", "/images/cumin-ground-and-seed.jpeg","","4",4, recipe6);
        ingredientRepo.save(tofuIngredient3);
        Ingredient tofuIngredient4 = new Ingredient(" Tablespoon finely chopped ginger", "/images/cumin-ground-and-seed.jpeg","","2",2, recipe6);
        ingredientRepo.save(tofuIngredient4);
        Ingredient tofuIngredient5 = new Ingredient("Tablespoons curry powder","/images/cumin-ground-and-seed.jpeg","","3",3, recipe6);
        ingredientRepo.save(tofuIngredient5);
        Ingredient tofuIngredient6 = new Ingredient("Cups vegetable stock","/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient6);
        Ingredient tofuIngredient7 = new Ingredient("  (14 ounce) can coconut milk", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient7);
        Ingredient tofuIngredient8 = new Ingredient("large yam, cut into chunks","/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient8);
        Ingredient tofuIngredient9 = new Ingredient("large carrots, cut into chunks", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient9);
        Ingredient tofuIngredient10 = new Ingredient("ribs celery, chopped", "/images/cumin-ground-and-seed.jpeg","","1",1, recipe6);
        ingredientRepo.save(tofuIngredient10);
        Ingredient tofuIngredient11 = new Ingredient("cup red lentils", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient11);
        Ingredient tofuIngredient12 = new Ingredient("cup minced lemongrass","/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient12);
        Ingredient tofuIngredient13 = new Ingredient("tablespoons white sugar","/images/cumin-ground-and-seed.jpeg","","1",1, recipe6);
        ingredientRepo.save(tofuIngredient13);
        Ingredient tofuIngredient14 = new Ingredient("salt to taste", "/images/cumin-ground-and-seed.jpeg","","0",0, recipe6);
        ingredientRepo.save(tofuIngredient14);
        Ingredient tofuIngredient15 = new Ingredient("package medium-firm tofu, cubed and patted dry", "/images/cumin-ground-and-seed.jpeg","","1",1, recipe6);
